...
class JobAgent:
    ...
    def run(self, profile: dict, saved_state: dict = None) -> dict:
        ...
        system_prompt = (
            "You are an autonomous job search agent. Your ONLY goal:\n"
            "Get interview callbacks for " + name + ".\n\n"
            "CANDIDATE: " + title + ", " + str(exp) + " years experience\n"
            "SKILLS: " + skills + "\n\n"
            ...
            "Step 1b: If 0 jobs returned, try shorter keywords\n"
            "Step 2: Call evaluate_jobs with ALL job_ids from search\n"
            "Step 3: For score >= 85: prepare_application then mark_applied(method='auto')\n"
            "Step 4: For score 60-84: request_human_approval\n"
            "Step 5: For applications older than 7 days: draft_followup\n"
            "Step 6: Call finish with summary\n\n"
            "CRITICAL: Call search_jobs FIRST. Do NOT skip it. Do NOT invent job boards."
        )
